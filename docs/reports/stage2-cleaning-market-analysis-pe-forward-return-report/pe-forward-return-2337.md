...
tags:
  ...
  - 互動式圖表
  - 半導體業
description: "2337 旺宏 (半導體業) 本益比與未來報酬率關係分析 - 互動式多期間版本"
---
...
!!! info "報告資訊"
    ...
    - **報告類型**: 互動式多期間分析
    - **可選期間**: 10年
    - **報告生成時間**: 2026-08-11 19:38:10 CST
...
!!! note "本益比河流帶水位: 5.6倍、8.1倍、10.6倍、13.8倍、22.7倍"

```vegalite
{
  "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
  "title": "2337 旺宏 - 本益比河流帶",
  "data": {
    "values": [
      {
        "date": "2006-09-15",
...
|:---:|:---:|:---:|:---:|:---|:---|
| 10年 | 17.3 | +11.6% | 0.012 | 2016-05 (+50.0%) | 2006-11 (-12.0%) |
...
*數據更新時間: 2026-08-11 19:38:10 CST*
