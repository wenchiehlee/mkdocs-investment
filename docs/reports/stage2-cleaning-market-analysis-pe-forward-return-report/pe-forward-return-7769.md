...
tags:
  ...
  - 互動式圖表
  - 半導體業
description: "7769 鴻勁 (半導體業) 本益比與未來報酬率關係分析 - 互動式多期間版本"
---
...
!!! info "報告資訊"
    ...
    - **報告類型**: 互動式多期間分析
    - **可選期間**: 3個月
    - **報告生成時間**: 2026-05-16 13:57:08 CST
...
!!! note "本益比河流帶水位: 42.4倍、45.5倍、47.9倍、56.6倍、61.6倍"

```vegalite
{
  "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
  "title": "7769 鴻勁 - 本益比河流帶",
  "data": {
    "values": [
      {
        "date": "2025-11-15",
...
|:---:|:---:|:---:|:---:|:---|:---|
| 3個月 | 42.4 | +35.2% | 1.000 | 2025-11 (+60.6%) | 2025-12 (+9.8%) |
...
*數據更新時間: 2026-05-16 13:57:08 CST*
