...
tags:
  ...
  - 互動式圖表
  - 半導體業
description: "3443 創意 (半導體業) 本益比與未來報酬率關係分析 - 互動式多期間版本"
---
...
!!! info "報告資訊"
    ...
    - **報告類型**: 互動式多期間分析
    - **可選期間**: 10年
    - **報告生成時間**: 2026-08-14 22:11:56 CST
...
!!! note "本益比河流帶水位: 20.8倍、26.8倍、35.3倍、48.3倍、60.7倍"

```vegalite
{
  "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
  "title": "3443 創意 - 本益比河流帶",
  "data": {
    "values": [
      {
        "date": "2006-11-15",
...
|:---:|:---:|:---:|:---:|:---|:---|
| 10年 | 31.7 | +17.1% | 0.399 | 2016-06 (+52.1%) | 2007-03 (-9.7%) |
...
*數據更新時間: 2026-08-14 22:11:56 CST*
