---
title: "7765 中華資安 - 本益比與未來報酬率分析 (互動式)"
authors:
...
tags:
  ...
  - 互動式圖表
  - 數位雲端
description: "7765 中華資安 (數位雲端) 本益比與未來報酬率關係分析 - 互動式多期間版本"
---
...
!!! info "報告資訊"
    ...
    - **報告類型**: 互動式多期間分析
    - **可選期間**: 3個月
    - **報告生成時間**: 2026-02-07 12:44:44 CST
...
!!! note "本益比河流帶水位: 23.0倍、24.3倍、24.4倍、25.0倍、25.6倍"

```vegalite
{
  "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
  "title": "7765 中華資安 - 本益比河流帶",
  "data": {
    "values": [
      {
        "date": "2025-09-15",
...
|:---:|:---:|:---:|:---:|:---|:---|
| 3個月 | 25.3 | -24.0% | 1.000 | 2025-09 (-16.2%) | 2025-10 (-31.8%) |
...
*數據更新時間: 2026-02-07 12:44:44 CST*
