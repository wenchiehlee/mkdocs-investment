---
title: "7722 LINEPAY - 本益比與未來報酬率分析 (互動式)"
authors:
...
tags:
  ...
  - 互動式圖表
  - 數位雲端
description: "7722 LINEPAY (數位雲端) 本益比與未來報酬率關係分析 - 互動式多期間版本"
---

# 7722 LINEPAY - 本益比與未來報酬率分析
...
!!! info "報告資訊"
    ...
    - **報告類型**: 互動式多期間分析
    - **可選期間**: 3個月, 6個月, 1年
    - **報告生成時間**: 2026-05-02 13:42:11 CST
...
```vegalite
{
  ...
  "title": "7722 LINEPAY - 本益比與未來報酬率分析",
  "data": {
    "values": [
      {
        "horizon": "0.25y",
...
!!! note "本益比河流帶水位: 42.4倍、61.9倍、72.4倍、75.2倍、85.4倍"

```vegalite
{
  "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
  "title": "7722 LINEPAY - 本益比河流帶",
  "data": {
    "values": [
      {
        "date": "2024-12-16",
...
|:---:|:---:|:---:|:---:|:---|:---|
| 3個月 | 74.7 | -6.8% | 0.548 | 2024-12 (+259.9%) | 2025-12 (-92.6%) |
| 6個月 | 75.2 | -20.4% | 0.568 | 2024-12 (+117.0%) | 2025-09 (-75.7%) |
| 1年 | 68.4 | -31.9% | 0.876 | 2024-12 (+24.4%) | 2025-03 (-52.1%) |
...
*數據更新時間: 2026-05-02 13:42:11 CST*
