...
| 指標 | 平均-σlo | 平均 | 平均+σup |
|:----:|:---------:|:----:|:--------:|
| **EPS(元)** | **4.11** | **5.51** | **6.21** |
| **P/E倍數** | **8.41** | **11.29** | **14.40** |

!!! tip "非對稱統計基準說明"
    - **σup (上標準差)**: 用於計算高於平均值的離散程度
    - **σlo (下標準差)**: 用於計算低於平均值的離散程度
    - **非對稱設計**: 更準確反映金融數據的偏態分布特性
    - **EPSbase**: 台灣虎航 歷史平均獲利能力 (σup=0.70, σlo=1.40)
    - **P/Ebase**: 台灣虎航 歷史平均估值水準 (σup=3.11, σlo=2.87)
...
|:---------------:|:---------------------------:|:--------------------------------:|:-------------------:|:----------:|:-----------------:|:-----------------:|
| **2026/06** | **16.16** | <span style="color: #DC143C; font-weight: bold;">+27.1</span> | <span style="color: #DC143C; font-weight: bold;">+22.1</span> | **62.3** | <span style="color: #DC143C; font-weight: bold;">6.23</span> | <span style="color: #004225; font-weight: bold;">9.49</span> |
