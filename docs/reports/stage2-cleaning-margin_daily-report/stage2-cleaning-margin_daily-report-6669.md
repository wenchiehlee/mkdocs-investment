...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-29
    **🕒 更新時間**: 2026-01-30 19:10:52 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 94.2 億元 (2,531 張) | - |
| **最新收盤價** | 3720.00 元 | - |
| **市值** | 6,644 億元 | - |
| **融資餘額/市值** | 1.42% | 🔴 過熱 |
| **日變化 (DoD)** | -2.3 億元 (-2.33%) | 📉 |
| **週變化 (WoW)** | +7.1 億元 (+8.16%) | 📈 |
| **兩週變化 (2Wo2W)** | +10.8 億元 (+12.57%) | 📈 |
| **月變化 (MoM)** | +10.7 億元 (+12.49%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6669.json" data-title="融資餘額"></div>
</div>
