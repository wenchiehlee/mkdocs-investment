...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:32:15 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 323.9 億元 (136,935 張) | - |
| **最新收盤價** | 236.50 元 | - |
| **市值** | 7,359 億元 | - |
| **融資餘額/市值** | 4.40% | 🔴 過熱 |
| **日變化 (DoD)** | +6.5 億元 (+2.06%) | 📈 |
| **週變化 (WoW)** | -44.8 億元 (-12.14%) | 📉 |
| **兩週變化 (2Wo2W)** | +23.7 億元 (+8.49%) | 📈 |
| **月變化 (MoM)** | +84.1 億元 (+38.32%) | 📈 |
...
![Stock 2408 Margin Balance Analysis](margin_daily-2408.svg){: style="max-width: 100%; height: auto;"}
</div>
