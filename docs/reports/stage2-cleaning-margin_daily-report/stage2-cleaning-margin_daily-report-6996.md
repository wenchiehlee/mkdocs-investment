...
| **市值** | 78 億元 | - |
| **融資餘額/市值** | 0.47% | 🟡 正常 |
| **日變化 (DoD)** | +0.0 億元 (+12.07%) | 📈 |
| **週變化 (WoW)** | +0.2 億元 (+106.61%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.2 億元 (+107.27%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+93.93%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6996.json" data-title="融資餘額"></div>
</div>
