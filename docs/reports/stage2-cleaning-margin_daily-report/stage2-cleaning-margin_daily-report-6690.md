...
| **市值** | 50 億元 | - |
| **融資餘額/市值** | 0.38% | 🟡 正常 |
| **日變化 (DoD)** | +0.0 億元 (+16.08%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+44.18%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+26.13%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+25.07%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6690.json" data-title="融資餘額"></div>
</div>
