...
| **市值** | 51 億元 | - |
| **融資餘額/市值** | 0.26% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+11.53%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+14.14%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+47.53%) | 📈 |
...
![Stock 6690 Margin Balance Analysis](margin_daily-6690.svg){: style="max-width: 100%; height: auto;"}
</div>
