...
| **市值** | 19 億元 | - |
| **融資餘額/市值** | 0.00% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-100.00%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-100.00%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-100.00%) | 📉 |
| **月變化 (MoM)** | -0.0 億元 (-100.00%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-6997.json" data-title="融資餘額"></div>
</div>
