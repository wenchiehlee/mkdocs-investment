...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 14:33:55 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 0.8 億元 (2,281 張) | - |
| **最新收盤價** | 33.10 元 | - |
| **市值** | 169 億元 | - |
| **融資餘額/市值** | 0.45% | 🟡 正常 |
| **日變化 (DoD)** | -0.0 億元 (-0.04%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-0.77%) | 📉 |
| **月變化 (MoM)** | +0.1 億元 (+11.33%) | 📈 |
...
![Stock 4114 Margin Balance Analysis](margin_daily-4114.svg){: style="max-width: 100%; height: auto;"}
</div>
