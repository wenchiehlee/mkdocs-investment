...
!!! info "基本資訊"
    **🏗️ 名稱**: 可成
    **🪪 代號**: 2474
    **📅 分析期間**: 2025-07-22 ~ 2026-01-13 (共 243 個交易日)
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-15 02:09:05 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.4 億元 (1,608 張) | - |
| **最新收盤價** | 209.50 元 | - |
| **市值** | 1,255 億元 | - |
| **融資餘額/市值** | 0.27% | 🟢 低風險 |
| **日變化 (DoD)** | -0.5 億元 (-12.06%) | 📉 |
| **週變化 (WoW)** | -1.0 億元 (-22.42%) | 📉 |
| **月變化 (MoM)** | +0.0 億元 (+0.30%) | 📈 |
...
![Stock 2474 Margin Balance Analysis](margin_daily-2474.svg){: style="max-width: 100%; height: auto;"}
</div>
