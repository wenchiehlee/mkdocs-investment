...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 13:26:13 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 8.9 億元 (28,364 張) | - |
| **最新收盤價** | 31.35 元 | - |
| **市值** | 1,382 億元 | - |
| **融資餘額/市值** | 0.64% | 🟠 偏高 |
| **日變化 (DoD)** | -0.1 億元 (-0.56%) | 📉 |
| **週變化 (WoW)** | -1.1 億元 (-10.86%) | 📉 |
...
![Stock 2324 Margin Balance Analysis](margin_daily-2324.svg){: style="max-width: 100%; height: auto;"}
</div>
