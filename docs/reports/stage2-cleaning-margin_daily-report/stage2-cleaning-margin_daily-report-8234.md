...
tags:
  ...
  - 融資
  - 市場情緒
title: 融資餘額報告 新漢 (8234)
comments: false
draft: false
description: 融資餘額報告 新漢 (8234) - 自動產生
---
...
| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.9 億元 (4,223 張) | - |
| **最新收盤價** | 69.80 元 | - |
| **市值** | 99 億元 | - |
| **融資餘額/市值** | 2.99% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-1.56%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-1.38%) | 📉 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+1.37%) | 📈 |
| **月變化 (MoM)** | -1.2 億元 (-28.21%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-8234.json" data-title="融資餘額"></div>
</div>
