...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:32:53 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.4 億元 (2,070 張) | - |
| **最新收盤價** | 116.00 元 | - |
| **市值** | 192 億元 | - |
| **融資餘額/市值** | 1.25% | 🔴 過熱 |
| **日變化 (DoD)** | +0.1 億元 (+3.19%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+1.45%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.2 億元 (+9.76%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+8.06%) | 📈 |
...
![Stock 3014 Margin Balance Analysis](margin_daily-3014.svg){: style="max-width: 100%; height: auto;"}
</div>
