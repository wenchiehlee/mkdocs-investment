...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-02-05
    **🕒 更新時間**: 2026-02-06 21:48:15 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.5 億元 (6,656 張) | - |
| **最新收盤價** | 37.25 元 | - |
| **市值** | 98 億元 | - |
| **融資餘額/市值** | 2.53% | 🔴 過熱 |
| **日變化 (DoD)** | -0.1 億元 (-3.05%) | 📉 |
| **週變化 (WoW)** | -0.5 億元 (-16.71%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.3 億元 (-11.15%) | 📉 |
| **月變化 (MoM)** | -0.7 億元 (-21.62%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-3048.json" data-title="融資餘額"></div>
</div>
