...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 22:27:26 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.9 億元 (7,004 張) | - |
| **最新收盤價** | 41.30 元 | - |
| **市值** | 111 億元 | - |
| **融資餘額/市值** | 2.61% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-0.12%) | 📉 |
| **週變化 (WoW)** | -0.5 億元 (-15.97%) | 📉 |
| **兩週變化 (2Wo2W)** | +0.5 億元 (+17.12%) | 📈 |
| **月變化 (MoM)** | +0.4 億元 (+15.79%) | 📈 |
...
![Stock 3048 Margin Balance Analysis](margin_daily-3048.svg){: style="max-width: 100%; height: auto;"}
</div>
