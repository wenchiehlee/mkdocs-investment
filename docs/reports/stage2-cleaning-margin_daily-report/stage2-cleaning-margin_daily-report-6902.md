...
| **融資餘額/市值** | 1.15% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+6.74%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+16.13%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+16.92%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+17.35%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6902.json" data-title="融資餘額"></div>
</div>
