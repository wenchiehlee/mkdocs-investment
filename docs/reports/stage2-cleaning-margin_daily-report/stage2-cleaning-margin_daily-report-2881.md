...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-04-02
    **🕒 更新時間**: 2026-04-05 21:40:39 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 6.5 億元 (7,423 張) | - |
| **最新收盤價** | 87.80 元 | - |
| **市值** | 1.23 兆元 | - |
| **融資餘額/市值** | 0.05% | 🟢 低風險 |
| **日變化 (DoD)** | -0.1 億元 (-1.98%) | 📉 |
| **週變化 (WoW)** | -0.9 億元 (-12.55%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.8 億元 (-10.24%) | 📉 |
| **月變化 (MoM)** | -1.0 億元 (-13.57%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-2881.json" data-title="融資餘額"></div>
</div>
