...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:58:31 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 6.8 億元 (7,195 張) | - |
| **最新收盤價** | 95.00 元 | - |
| **市值** | 1.34 兆元 | - |
| **融資餘額/市值** | 0.05% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-0.36%) | 📉 |
...
![Stock 2881 Margin Balance Analysis](margin_daily-2881.svg){: style="max-width: 100%; height: auto;"}
</div>
