...
!!! info "基本資訊"
    **🏗️ 名稱**: 鴻勁
    **🪪 代號**: 7769
    **📅 分析期間**: 2025-11-27 ~ 2026-01-16 (共 35 個交易日)
    **🕒 最新資料**: 2026-01-16
    **🕒 更新時間**: 2026-01-17 20:39:00 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 104.9 億元 (2,993 張) | - |
| **最新收盤價** | 3505.00 元 | - |
| **市值** | 6,352 億元 | - |
| **融資餘額/市值** | 1.65% | 🔴 過熱 |
| **日變化 (DoD)** | -39.8 億元 (-27.48%) | 📉 |
| **週變化 (WoW)** | -54.4 億元 (-34.15%) | 📉 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+105.65%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+5.81%) | 📈 |
