...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:34:36 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 4.9 億元 (1,110 張) | - |
| **最新收盤價** | 441.50 元 | - |
| **市值** | 737 億元 | - |
| **融資餘額/市值** | 0.66% | 🟠 偏高 |
| **日變化 (DoD)** | +0.1 億元 (+1.69%) | 📈 |
| **週變化 (WoW)** | -0.1 億元 (-1.09%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.1 億元 (-2.27%) | 📉 |
| **月變化 (MoM)** | -0.3 億元 (-5.26%) | 📉 |
...
![Stock 6526 Margin Balance Analysis](margin_daily-6526.svg){: style="max-width: 100%; height: auto;"}
</div>
