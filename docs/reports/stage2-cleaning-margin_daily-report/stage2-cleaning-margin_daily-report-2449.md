...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:57:59 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 40.8 億元 (15,098 張) | - |
| **最新收盤價** | 270.00 元 | - |
| **市值** | 3,222 億元 | - |
| **融資餘額/市值** | 1.27% | 🔴 過熱 |
| **日變化 (DoD)** | +1.9 億元 (+4.98%) | 📈 |
| **週變化 (WoW)** | -5.9 億元 (-12.69%) | 📉 |
| **月變化 (MoM)** | +2.6 億元 (+6.79%) | 📈 |
...
![Stock 2449 Margin Balance Analysis](margin_daily-2449.svg){: style="max-width: 100%; height: auto;"}
</div>
