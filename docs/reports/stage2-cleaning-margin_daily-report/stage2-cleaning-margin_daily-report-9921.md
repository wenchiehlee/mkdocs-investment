...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-15 02:12:07 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.5 億元 (1,625 張) | - |
| **最新收盤價** | 90.10 元 | - |
| **市值** | 368 億元 | - |
| **融資餘額/市值** | 0.40% | 🟡 正常 |
| **日變化 (DoD)** | +0.1 億元 (+8.38%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+10.10%) | 📈 |
| **月變化 (MoM)** | +0.1 億元 (+10.93%) | 📈 |
...
![Stock 9921 Margin Balance Analysis](margin_daily-9921.svg){: style="max-width: 100%; height: auto;"}
</div>
