...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-03-12
    **🕒 更新時間**: 2026-03-13 12:34:45 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.2 億元 (1,720 張) | - |
| **最新收盤價** | 72.10 元 | - |
| **市值** | 283 億元 | - |
| **融資餘額/市值** | 0.44% | 🟡 正常 |
| **日變化 (DoD)** | +0.0 億元 (+0.48%) | 📈 |
| **週變化 (WoW)** | -0.2 億元 (-11.11%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.2 億元 (-12.00%) | 📉 |
| **月變化 (MoM)** | -0.2 億元 (-15.25%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-9921.json" data-title="融資餘額"></div>
</div>
