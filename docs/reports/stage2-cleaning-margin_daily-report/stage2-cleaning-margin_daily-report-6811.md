...
| **融資餘額/市值** | 0.92% | 🟠 偏高 |
| **日變化 (DoD)** | -0.1 億元 (-7.48%) | 📉 |
| **週變化 (WoW)** | -0.1 億元 (-11.35%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.1 億元 (-12.65%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-15.41%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-6811.json" data-title="融資餘額"></div>
</div>
