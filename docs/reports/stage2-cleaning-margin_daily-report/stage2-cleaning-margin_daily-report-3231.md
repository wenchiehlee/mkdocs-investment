...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:07:11 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 75.5 億元 (51,715 張) | - |
| **最新收盤價** | 146.00 元 | - |
| **市值** | 4,643 億元 | - |
| **融資餘額/市值** | 1.63% | 🔴 過熱 |
| **日變化 (DoD)** | +3.1 億元 (+4.21%) | 📈 |
| **週變化 (WoW)** | -5.7 億元 (-7.02%) | 📉 |
| **兩週變化 (2Wo2W)** | -5.1 億元 (-6.37%) | 📉 |
| **月變化 (MoM)** | -5.0 億元 (-6.21%) | 📉 |
...
![Stock 3231 Margin Balance Analysis](margin_daily-3231.svg){: style="max-width: 100%; height: auto;"}
</div>
