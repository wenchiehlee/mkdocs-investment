...
!!! info "基本資訊"
    **🏗️ 名稱**: 嘉實
    **🪪 代號**: 3158
    **📅 分析期間**: 2025-11-17 ~ 2026-01-12 (共 39 個交易日)
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 14:33:41 CST
...
| **市值** | 28 億元 | - |
| **融資餘額/市值** | 0.11% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+72.72%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+18.86%) | 📈 |
| **月變化 (MoM)** | -0.1 億元 (-63.76%) | 📉 |
