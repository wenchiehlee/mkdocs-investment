...
!!! info "基本資訊"
    **🏗️ 名稱**: 嘉實
    **🪪 代號**: 3158
    **📅 分析期間**: 2025-11-17 ~ 2026-01-13 (共 40 個交易日)
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-14 22:38:52 CST
...
| **市值** | 28 億元 | - |
| **融資餘額/市值** | 0.09% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-23.28%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-10.59%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-70.57%) | 📉 |
