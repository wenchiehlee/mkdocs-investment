...
!!! info "基本資訊"
    **🏗️ 名稱**: 嘉實
    **🪪 代號**: 3158
    **📅 分析期間**: 2025-11-17 ~ 2026-02-11 (共 61 個交易日)
    **🕒 最新資料**: 2026-02-11
    **🕒 更新時間**: 2026-02-23 21:55:52 CST
...
| **市值** | 27 億元 | - |
| **融資餘額/市值** | 0.12% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+15.23%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+360.42%) | 📈 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-91.00%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-3158.json" data-title="融資餘額"></div>
</div>
