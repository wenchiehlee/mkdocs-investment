...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-23
    **🕒 更新時間**: 2026-01-24 21:16:32 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 32.1 億元 (16,913 張) | - |
| **最新收盤價** | 189.50 元 | - |
| **市值** | 4,103 億元 | - |
| **融資餘額/市值** | 0.78% | 🟠 偏高 |
| **日變化 (DoD)** | -0.1 億元 (-0.24%) | 📉 |
| **週變化 (WoW)** | -1.1 億元 (-3.20%) | 📉 |
| **兩週變化 (2Wo2W)** | -1.9 億元 (-5.56%) | 📉 |
| **月變化 (MoM)** | -3.8 億元 (-10.62%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-2603.json" data-title="融資餘額"></div>
</div>
