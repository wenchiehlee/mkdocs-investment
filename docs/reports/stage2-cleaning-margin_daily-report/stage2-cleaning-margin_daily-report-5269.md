...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:33:51 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 32.6 億元 (2,423 張) | - |
| **最新收盤價** | 1345.00 元 | - |
| **市值** | 998 億元 | - |
| **融資餘額/市值** | 3.26% | 🔴 過熱 |
| **日變化 (DoD)** | +3.8 億元 (+13.08%) | 📈 |
| **週變化 (WoW)** | +3.9 億元 (+13.62%) | 📈 |
...
![Stock 5269 Margin Balance Analysis](margin_daily-5269.svg){: style="max-width: 100%; height: auto;"}
</div>
