...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:07:27 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 189.6 億元 (5,479 張) | - |
| **最新收盤價** | 3460.00 元 | - |
| **市值** | 2,798 億元 | - |
| **融資餘額/市值** | 6.78% | 🔴 過熱 |
| **日變化 (DoD)** | -12.3 億元 (-6.11%) | 📉 |
| **週變化 (WoW)** | -14.2 億元 (-6.96%) | 📉 |
...
![Stock 3661 Margin Balance Analysis](margin_daily-3661.svg){: style="max-width: 100%; height: auto;"}
</div>
