...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-02-11
    **🕒 更新時間**: 2026-02-12 19:21:40 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 7.0 億元 (11,120 張) | - |
| **最新收盤價** | 63.00 元 | - |
| **市值** | 163 億元 | - |
| **融資餘額/市值** | 4.29% | 🔴 過熱 |
| **日變化 (DoD)** | -0.2 億元 (-2.13%) | 📉 |
| **週變化 (WoW)** | -1.3 億元 (-15.63%) | 📉 |
| **兩週變化 (2Wo2W)** | -1.5 億元 (-16.57%) | 📉 |
| **月變化 (MoM)** | -1.7 億元 (-18.85%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-6125.json" data-title="融資餘額"></div>
</div>
