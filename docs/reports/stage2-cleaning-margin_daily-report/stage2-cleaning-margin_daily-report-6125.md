...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:08:04 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 9.6 億元 (13,137 張) | - |
| **最新收盤價** | 72.80 元 | - |
| **市值** | 189 億元 | - |
| **融資餘額/市值** | 5.07% | 🔴 過熱 |
| **日變化 (DoD)** | +0.3 億元 (+3.32%) | 📈 |
| **週變化 (WoW)** | -0.3 億元 (-3.13%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.1 億元 (-0.93%) | 📉 |
| **月變化 (MoM)** | +1.3 億元 (+16.03%) | 📈 |
...
![Stock 6125 Margin Balance Analysis](margin_daily-6125.svg){: style="max-width: 100%; height: auto;"}
</div>
