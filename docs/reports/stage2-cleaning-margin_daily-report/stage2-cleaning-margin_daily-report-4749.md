...
!!! info "基本資訊"
    **🏗️ 名稱**: 新應材
    **🪪 代號**: 4749
    **📅 分析期間**: 2025-07-23 ~ 2026-01-14 (共 241 個交易日)
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:33:41 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 28.5 億元 (3,123 張) | - |
| **最新收盤價** | 913.00 元 | - |
| **市值** | 841 億元 | - |
| **融資餘額/市值** | 3.39% | 🔴 過熱 |
| **日變化 (DoD)** | -0.2 億元 (-0.53%) | 📉 |
| **週變化 (WoW)** | +1.3 億元 (+4.80%) | 📈 |
| **兩週變化 (2Wo2W)** | +6.5 億元 (+30.24%) | 📈 |
| **月變化 (MoM)** | +4.8 億元 (+20.70%) | 📈 |
