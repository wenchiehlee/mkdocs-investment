...
| **融資餘額/市值** | 0.63% | 🟠 偏高 |
| **日變化 (DoD)** | +0.0 億元 (+1.12%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+15.14%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.1 億元 (+16.61%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+24.04%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6613.json" data-title="融資餘額"></div>
</div>
