...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:58:09 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 19.3 億元 (8,156 張) | - |
| **最新收盤價** | 237.00 元 | - |
| **市值** | 1,040 億元 | - |
| **融資餘額/市值** | 1.86% | 🔴 過熱 |
| **日變化 (DoD)** | +1.9 億元 (+11.17%) | 📈 |
| **週變化 (WoW)** | +6.5 億元 (+50.73%) | 📈 |
| **月變化 (MoM)** | +14.4 億元 (+296.04%) | 📈 |
...
![Stock 2451 Margin Balance Analysis](margin_daily-2451.svg){: style="max-width: 100%; height: auto;"}
</div>
