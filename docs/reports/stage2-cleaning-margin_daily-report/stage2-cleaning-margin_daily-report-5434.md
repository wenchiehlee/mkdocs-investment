...
| **市值** | 767 億元 | - |
| **融資餘額/市值** | 0.32% | 🟡 正常 |
| **日變化 (DoD)** | -0.3 億元 (-10.84%) | 📉 |
| **週變化 (WoW)** | +0.9 億元 (+57.15%) | 📈 |
| **兩週變化 (2Wo2W)** | +1.2 億元 (+72.25%) | 📈 |
| **月變化 (MoM)** | +1.2 億元 (+74.78%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-5434.json" data-title="融資餘額"></div>
</div>
