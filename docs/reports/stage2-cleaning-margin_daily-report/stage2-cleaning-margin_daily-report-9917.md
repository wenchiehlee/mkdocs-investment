...
| **市值** | 496 億元 | - |
| **融資餘額/市值** | 0.02% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+12.50%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+10.60%) | 📈 |
| **月變化 (MoM)** | -0.0 億元 (-6.35%) | 📉 |
...
![Stock 9917 Margin Balance Analysis](margin_daily-9917.svg){: style="max-width: 100%; height: auto;"}
</div>
