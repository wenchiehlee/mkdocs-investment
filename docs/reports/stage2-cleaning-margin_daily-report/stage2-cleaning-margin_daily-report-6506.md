...
| **市值** | 15 億元 | - |
| **融資餘額/市值** | 0.51% | 🟠 偏高 |
| **日變化 (DoD)** | +0.0 億元 (+20.83%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+99.49%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+127.68%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+104.61%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6506.json" data-title="融資餘額"></div>
</div>
