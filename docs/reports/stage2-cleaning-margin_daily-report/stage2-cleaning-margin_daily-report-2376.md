...
!!! info "基本資訊"
    **🏗️ 名稱**: 技嘉
    **🪪 代號**: 2376
    **📅 分析期間**: 2025-07-28 ~ 2026-01-19 (共 243 個交易日)
    **🕒 最新資料**: 2026-01-19
    **🕒 更新時間**: 2026-01-20 23:06:56 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 18.8 億元 (7,844 張) | - |
| **最新收盤價** | 240.00 元 | - |
| **市值** | 1,594 億元 | - |
| **融資餘額/市值** | 1.18% | 🔴 過熱 |
| **日變化 (DoD)** | -1.9 億元 (-8.95%) | 📉 |
| **週變化 (WoW)** | +1.7 億元 (+10.08%) | 📈 |
| **兩週變化 (2Wo2W)** | +4.4 億元 (+26.90%) | 📈 |
| **月變化 (MoM)** | +4.4 億元 (+26.99%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2376.json" data-title="融資餘額"></div>
</div>
