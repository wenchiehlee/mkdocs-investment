...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:05:51 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 20.0 億元 (8,079 張) | - |
| **最新收盤價** | 247.00 元 | - |
| **市值** | 1,655 億元 | - |
| **融資餘額/市值** | 1.21% | 🔴 過熱 |
| **日變化 (DoD)** | +2.4 億元 (+13.69%) | 📈 |
| **週變化 (WoW)** | +3.5 億元 (+21.26%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.6 億元 (+3.45%) | 📈 |
| **月變化 (MoM)** | +0.7 億元 (+4.62%) | 📈 |
...
![Stock 2376 Margin Balance Analysis](margin_daily-2376.svg){: style="max-width: 100%; height: auto;"}
</div>
