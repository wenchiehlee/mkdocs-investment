...
!!! info "基本資訊"
    **🏗️ 名稱**: 愛派司
    **🪪 代號**: 6918
    **📅 分析期間**: 2025-07-23 ~ 2026-01-14 (共 151 個交易日)
    **🕒 最新資料**: 2026-01-14
...
| **市值** | 29 億元 | - |
| **融資餘額/市值** | 0.01% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+64.68%) | 📈 |
| **週變化 (WoW)** | -0.0 億元 (-38.97%) | 📉 |
...
![Stock 6918 Margin Balance Analysis](margin_daily-6918.svg){: style="max-width: 100%; height: auto;"}
</div>
