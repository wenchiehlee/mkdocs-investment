...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-03-31
    **🕒 更新時間**: 2026-04-01 13:21:23 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.6 億元 (2,832 張) | - |
| **最新收盤價** | 93.50 元 | - |
| **市值** | 156 億元 | - |
| **融資餘額/市值** | 1.70% | 🔴 過熱 |
| **日變化 (DoD)** | -0.1 億元 (-1.96%) | 📉 |
| **週變化 (WoW)** | -0.4 億元 (-11.68%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.7 億元 (-21.08%) | 📉 |
| **月變化 (MoM)** | -1.0 億元 (-27.51%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-3029.json" data-title="融資餘額"></div>
</div>
