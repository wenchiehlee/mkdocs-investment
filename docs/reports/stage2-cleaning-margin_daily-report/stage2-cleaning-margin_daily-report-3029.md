...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:06:56 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.8 億元 (3,403 張) | - |
| **最新收盤價** | 113.00 元 | - |
| **市值** | 189 億元 | - |
| **融資餘額/市值** | 2.04% | 🔴 過熱 |
| **日變化 (DoD)** | +0.1 億元 (+1.37%) | 📈 |
| **週變化 (WoW)** | -0.1 億元 (-2.60%) | 📉 |
| **兩週變化 (2Wo2W)** | +0.1 億元 (+3.23%) | 📈 |
| **月變化 (MoM)** | +0.1 億元 (+1.61%) | 📈 |
...
![Stock 3029 Margin Balance Analysis](margin_daily-3029.svg){: style="max-width: 100%; height: auto;"}
</div>
