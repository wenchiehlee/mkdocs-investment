...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-14 22:37:44 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 43.1 億元 (15,447 張) | - |
| **最新收盤價** | 279.00 元 | - |
| **市值** | 1.10 兆元 | - |
| **融資餘額/市值** | 0.39% | 🟡 正常 |
| **日變化 (DoD)** | -0.9 億元 (-2.04%) | 📉 |
| **週變化 (WoW)** | -4.9 億元 (-10.14%) | 📉 |
| **月變化 (MoM)** | +4.4 億元 (+11.44%) | 📈 |
...
![Stock 2382 Margin Balance Analysis](margin_daily-2382.svg){: style="max-width: 100%; height: auto;"}
</div>
