...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:05:49 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 10.0 億元 (1,011 張) | - |
| **最新收盤價** | 989.00 元 | - |
| **日變化 (DoD)** | -0.2 億元 (-1.92%) | 📉 |
| **週變化 (WoW)** | -1.5 億元 (-13.31%) | 📉 |
| **兩週變化 (2Wo2W)** | -3.9 億元 (-28.52%) | 📉 |
| **月變化 (MoM)** | -2.2 億元 (-18.37%) | 📉 |
...
![Stock 2360 Margin Balance Analysis](margin_daily-2360.svg){: style="max-width: 100%; height: auto;"}
</div>
