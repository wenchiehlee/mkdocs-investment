...
!!! info "基本資訊"
    **🏗️ 名稱**: 昕奇雲端
    **🪪 代號**: 7747
    **📅 分析期間**: 2025-07-21 ~ 2026-01-12 (共 126 個交易日)
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:58:15 CST
...
| **市值** | 33 億元 | - |
| **融資餘額/市值** | 0.02% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-36.18%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-43.51%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-94.46%) | 📉 |
