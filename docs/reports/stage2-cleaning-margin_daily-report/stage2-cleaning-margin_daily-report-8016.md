...
| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.6 億元 (1,394 張) | - |
| **最新收盤價** | 190.00 元 | - |
| **市值** | 228 億元 | - |
| **融資餘額/市值** | 1.16% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-0.36%) | 📉 |
| **週變化 (WoW)** | -0.3 億元 (-10.24%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.4 億元 (-12.37%) | 📉 |
| **月變化 (MoM)** | -0.9 億元 (-25.34%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-8016.json" data-title="融資餘額"></div>
</div>
