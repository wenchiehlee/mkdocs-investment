...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:09:15 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.6 億元 (1,899 張) | - |
| **最新收盤價** | 191.50 元 | - |
| **市值** | 230 億元 | - |
| **融資餘額/市值** | 1.58% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-0.70%) | 📉 |
| **週變化 (WoW)** | +0.4 億元 (+10.79%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.2 億元 (+6.30%) | 📈 |
| **月變化 (MoM)** | +0.1 億元 (+3.30%) | 📈 |
...
![Stock 8016 Margin Balance Analysis](margin_daily-8016.svg){: style="max-width: 100%; height: auto;"}
</div>
