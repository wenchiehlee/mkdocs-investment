...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 22:29:05 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.4 億元 (5,083 張) | - |
| **最新收盤價** | 67.00 元 | - |
| **市值** | 306 億元 | - |
| **融資餘額/市值** | 1.11% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+0.55%) | 📈 |
| **週變化 (WoW)** | -0.1 億元 (-3.73%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.1 億元 (-3.37%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-3.95%) | 📉 |
...
![Stock 6757 Margin Balance Analysis](margin_daily-6757.svg){: style="max-width: 100%; height: auto;"}
</div>
