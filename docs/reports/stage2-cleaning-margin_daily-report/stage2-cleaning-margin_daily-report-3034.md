...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 22:27:18 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 18.1 億元 (4,717 張) | - |
| **最新收盤價** | 383.00 元 | - |
| **市值** | 2,309 億元 | - |
| **融資餘額/市值** | 0.78% | 🟠 偏高 |
| **日變化 (DoD)** | +0.4 億元 (+2.23%) | 📈 |
| **週變化 (WoW)** | -0.2 億元 (-0.99%) | 📉 |
| **兩週變化 (2Wo2W)** | +3.3 億元 (+23.34%) | 📈 |
| **月變化 (MoM)** | +3.5 億元 (+24.98%) | 📈 |
...
![Stock 3034 Margin Balance Analysis](margin_daily-3034.svg){: style="max-width: 100%; height: auto;"}
</div>
