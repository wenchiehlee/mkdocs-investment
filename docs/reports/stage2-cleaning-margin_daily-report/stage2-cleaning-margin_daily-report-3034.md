...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-16
    **🕒 更新時間**: 2026-01-18 20:37:10 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 18.0 億元 (4,764 張) | - |
| **最新收盤價** | 378.00 元 | - |
| **市值** | 2,300 億元 | - |
| **融資餘額/市值** | 0.78% | 🟠 偏高 |
| **日變化 (DoD)** | +0.1 億元 (+0.53%) | 📈 |
| **週變化 (WoW)** | +0.4 億元 (+2.33%) | 📈 |
| **兩週變化 (2Wo2W)** | +3.3 億元 (+22.52%) | 📈 |
| **月變化 (MoM)** | +3.7 億元 (+26.23%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-3034.json" data-title="融資餘額"></div>
</div>
