...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-04-22
    **🕒 更新時間**: 2026-04-29 13:47:05 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.2 億元 (2,231 張) | - |
| **最新收盤價** | 53.40 元 | - |
| **市值** | 42 億元 | - |
| **融資餘額/市值** | 2.84% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+1.94%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+5.00%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.1 億元 (+10.50%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+19.08%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-3356.json" data-title="融資餘額"></div>
</div>
