...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-04-22
    **🕒 更新時間**: 2026-04-29 13:47:15 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.0 億元 (1,558 張) | - |
| **最新收盤價** | 126.00 元 | - |
| **市值** | 342 億元 | - |
| **融資餘額/市值** | 0.57% | 🟠 偏高 |
| **日變化 (DoD)** | +0.1 億元 (+7.90%) | 📈 |
| **週變化 (WoW)** | +0.5 億元 (+33.56%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.4 億元 (+25.97%) | 📈 |
| **月變化 (MoM)** | +0.3 億元 (+21.35%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6214.json" data-title="融資餘額"></div>
</div>
