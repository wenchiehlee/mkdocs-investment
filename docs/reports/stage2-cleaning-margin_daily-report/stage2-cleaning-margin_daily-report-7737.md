...
!!! info "基本資訊"
    **🏗️ 名稱**: 凱鈿
    **🪪 代號**: 7737
    **📅 分析期間**: 2025-07-22 ~ 2026-01-13 (共 234 個交易日)
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-15 02:11:43 CST
...
| **市值** | 11 億元 | - |
| **融資餘額/市值** | 0.01% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+53.23%) | 📈 |
| **週變化 (WoW)** | -0.0 億元 (-94.46%) | 📉 |
| **月變化 (MoM)** | -0.0 億元 (-84.05%) | 📉 |
...
![Stock 7737 Margin Balance Analysis](margin_daily-7737.svg){: style="max-width: 100%; height: auto;"}
</div>
