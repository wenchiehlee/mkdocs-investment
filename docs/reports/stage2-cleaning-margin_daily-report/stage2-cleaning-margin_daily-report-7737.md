...
!!! info "基本資訊"
    **🏗️ 名稱**: 凱鈿
    **🪪 代號**: 7737
    **📅 分析期間**: 2025-08-01 ~ 2026-01-23 (共 242 個交易日)
    **🕒 最新資料**: 2026-01-23
    **🕒 更新時間**: 2026-01-24 21:22:02 CST
...
| **市值** | 11 億元 | - |
| **融資餘額/市值** | 0.05% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-21.26%) | 📉 |
| **週變化 (WoW)** | +0.0 億元 (+140.00%) | 📈 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-23.53%) | 📉 |
| **月變化 (MoM)** | +0.0 億元 (+306.25%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7737.json" data-title="融資餘額"></div>
</div>
