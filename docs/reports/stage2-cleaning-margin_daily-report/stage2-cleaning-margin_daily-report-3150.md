...
| **市值** | 8 億元 | - |
| **融資餘額/市值** | 0.24% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+13.04%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+11.23%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+16.35%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+32.29%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-3150.json" data-title="融資餘額"></div>
</div>
