...
| **日變化 (DoD)** | +0.0 億元 (+0.25%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+5.29%) | 📈 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-31.19%) | 📉 |
| **月變化 (MoM)** | -0.0 億元 (-27.36%) | 📉 |
...
![Stock 3150 Margin Balance Analysis](margin_daily-3150.svg){: style="max-width: 100%; height: auto;"}
</div>
