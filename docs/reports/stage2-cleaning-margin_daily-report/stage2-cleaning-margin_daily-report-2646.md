...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-30
    **🕒 更新時間**: 2026-02-02 04:58:17 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 0.8 億元 (3,556 張) | - |
| **最新收盤價** | 22.95 元 | - |
| **市值** | 690 億元 | - |
| **融資餘額/市值** | 0.12% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-1.65%) | 📉 |
| **週變化 (WoW)** | +0.1 億元 (+16.13%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.2 億元 (+33.36%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+40.37%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2646.json" data-title="融資餘額"></div>
</div>
