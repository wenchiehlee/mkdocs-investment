...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-04-22
    **🕒 更新時間**: 2026-04-23 13:25:01 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 13.0 億元 (1,454 張) | - |
| **最新收盤價** | 896.00 元 | - |
| **市值** | 1,112 億元 | - |
| **融資餘額/市值** | 1.17% | 🔴 過熱 |
| **日變化 (DoD)** | -1.0 億元 (-6.94%) | 📉 |
| **週變化 (WoW)** | -3.5 億元 (-21.11%) | 📉 |
| **兩週變化 (2Wo2W)** | -3.4 億元 (-20.73%) | 📉 |
| **月變化 (MoM)** | -4.0 億元 (-23.28%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-5536.json" data-title="融資餘額"></div>
</div>
