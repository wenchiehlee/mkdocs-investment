...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-21
    **🕒 更新時間**: 2026-01-22 18:23:43 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 14.8 億元 (2,950 張) | - |
| **最新收盤價** | 501.00 元 | - |
| **市值** | 3,796 億元 | - |
| **融資餘額/市值** | 0.39% | 🟡 正常 |
| **日變化 (DoD)** | +0.3 億元 (+2.18%) | 📈 |
| **週變化 (WoW)** | +1.6 億元 (+11.79%) | 📈 |
| **兩週變化 (2Wo2W)** | +2.8 億元 (+23.79%) | 📈 |
| **月變化 (MoM)** | +4.4 億元 (+42.30%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2357.json" data-title="融資餘額"></div>
</div>
