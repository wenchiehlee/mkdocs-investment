...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:05:44 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 13.2 億元 (2,504 張) | - |
| **最新收盤價** | 528.00 元 | - |
| **市值** | 3,922 億元 | - |
| **融資餘額/市值** | 0.34% | 🟡 正常 |
| **日變化 (DoD)** | +0.2 億元 (+1.44%) | 📈 |
| **週變化 (WoW)** | +2.3 億元 (+21.56%) | 📈 |
| **兩週變化 (2Wo2W)** | +1.6 億元 (+14.95%) | 📈 |
| **月變化 (MoM)** | +2.6 億元 (+28.11%) | 📈 |
...
![Stock 2357 Margin Balance Analysis](margin_daily-2357.svg){: style="max-width: 100%; height: auto;"}
</div>
