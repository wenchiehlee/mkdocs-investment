...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-08-13
    **🕒 更新時間**: 2026-08-14 17:59:07 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 16.8 億元 (2,205 張) | - |
| **最新收盤價** | 762.00 元 | - |
| **市值** | 2,201 億元 | - |
| **融資餘額/市值** | 0.76% | 🟠 偏高 |
| **日變化 (DoD)** | -0.1 億元 (-0.54%) | 📉 |
| **週變化 (WoW)** | -1.6 億元 (-8.45%) | 📉 |
| **兩週變化 (2Wo2W)** | -1.0 億元 (-5.56%) | 📉 |
| **月變化 (MoM)** | -2.9 億元 (-14.14%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-3293.json" data-title="融資餘額"></div>
</div>
