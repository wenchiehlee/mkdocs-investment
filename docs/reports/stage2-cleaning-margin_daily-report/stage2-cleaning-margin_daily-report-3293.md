...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 22:27:36 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 28.7 億元 (3,780 張) | - |
| **最新收盤價** | 758.00 元 | - |
| **市值** | 2,128 億元 | - |
| **融資餘額/市值** | 1.35% | 🔴 過熱 |
| **日變化 (DoD)** | -0.5 億元 (-1.69%) | 📉 |
| **週變化 (WoW)** | -0.3 億元 (-1.01%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.4 億元 (-1.46%) | 📉 |
| **月變化 (MoM)** | -0.6 億元 (-2.06%) | 📉 |
...
![Stock 3293 Margin Balance Analysis](margin_daily-3293.svg){: style="max-width: 100%; height: auto;"}
</div>
