...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 12:03:15 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 14.1 億元 (13,868 張) | - |
| **最新收盤價** | 102.00 元 | - |
| **市值** | 862 億元 | - |
| **融資餘額/市值** | 1.64% | 🔴 過熱 |
| **日變化 (DoD)** | +0.7 億元 (+5.24%) | 📈 |
| **週變化 (WoW)** | +1.8 億元 (+14.23%) | 📈 |
| **月變化 (MoM)** | +1.5 億元 (+12.18%) | 📈 |
...
![Stock 2377 Margin Balance Analysis](margin_daily-2377.svg){: style="max-width: 100%; height: auto;"}
</div>
