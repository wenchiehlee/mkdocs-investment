...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-03-03
    **🕒 更新時間**: 2026-03-04 12:32:07 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.9 億元 (1,047 張) | - |
| **最新收盤價** | 185.50 元 | - |
| **市值** | 492 億元 | - |
| **融資餘額/市值** | 0.40% | 🟡 正常 |
| **日變化 (DoD)** | -0.0 億元 (-1.75%) | 📉 |
| **週變化 (WoW)** | +0.2 億元 (+10.92%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.3 億元 (+15.37%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+11.97%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-8454.json" data-title="融資餘額"></div>
</div>
