...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:57:39 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 11.1 億元 (9,999 張) | - |
| **最新收盤價** | 111.00 元 | - |
| **市值** | 501 億元 | - |
| **融資餘額/市值** | 2.22% | 🔴 過熱 |
| **日變化 (DoD)** | +1.3 億元 (+13.50%) | 📈 |
| **週變化 (WoW)** | +1.4 億元 (+14.49%) | 📈 |
| **月變化 (MoM)** | +4.0 億元 (+56.19%) | 📈 |
...
![Stock 6285 Margin Balance Analysis](margin_daily-6285.svg){: style="max-width: 100%; height: auto;"}
</div>
