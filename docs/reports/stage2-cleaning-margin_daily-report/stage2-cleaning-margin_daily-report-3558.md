...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-02-11
    **🕒 更新時間**: 2026-02-18 01:41:48 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.1 億元 (1,686 張) | - |
| **最新收盤價** | 126.50 元 | - |
| **市值** | 75 億元 | - |
| **融資餘額/市值** | 2.85% | 🔴 過熱 |
| **日變化 (DoD)** | -0.1 億元 (-3.67%) | 📉 |
| **週變化 (WoW)** | -0.3 億元 (-13.80%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.3 億元 (-10.89%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-3.80%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-3558.json" data-title="融資餘額"></div>
</div>
