...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:33:27 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.3 億元 (1,729 張) | - |
| **最新收盤價** | 134.50 元 | - |
| **市值** | 78 億元 | - |
| **融資餘額/市值** | 2.97% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-0.82%) | 📉 |
| **週變化 (WoW)** | +0.1 億元 (+4.13%) | 📈 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-1.43%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-3.59%) | 📉 |
...
![Stock 3558 Margin Balance Analysis](margin_daily-3558.svg){: style="max-width: 100%; height: auto;"}
</div>
