...
| **市值** | 24 億元 | - |
| **融資餘額/市值** | 0.02% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+11.37%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+96.62%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+120.43%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+97.04%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7732.json" data-title="融資餘額"></div>
</div>
