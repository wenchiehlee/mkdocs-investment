...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:31:24 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 142.2 億元 (60,623 張) | - |
| **最新收盤價** | 234.50 元 | - |
| **市值** | 3.26 兆元 | - |
| **融資餘額/市值** | 0.44% | 🟡 正常 |
| **日變化 (DoD)** | +3.2 億元 (+2.29%) | 📈 |
| **週變化 (WoW)** | -11.0 億元 (-7.17%) | 📉 |
...
![Stock 2317 Margin Balance Analysis](margin_daily-2317.svg){: style="max-width: 100%; height: auto;"}
</div>
