...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-23
    **🕒 更新時間**: 2026-01-24 17:09:23 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.9 億元 (4,933 張) | - |
| **最新收盤價** | 79.70 元 | - |
| **市值** | 76 億元 | - |
| **融資餘額/市值** | 5.19% | 🔴 過熱 |
| **日變化 (DoD)** | +0.4 億元 (+10.06%) | 📈 |
| **週變化 (WoW)** | +0.2 億元 (+4.78%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.3 億元 (+9.54%) | 📈 |
| **月變化 (MoM)** | +0.4 億元 (+12.85%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-8045.json" data-title="融資餘額"></div>
</div>
