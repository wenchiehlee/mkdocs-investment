...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-14 22:37:24 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 17.1 億元 (29,242 張) | - |
| **最新收盤價** | 58.50 元 | - |
| **市值** | 849 億元 | - |
| **融資餘額/市值** | 2.02% | 🔴 過熱 |
| **日變化 (DoD)** | -0.3 億元 (-1.75%) | 📉 |
| **週變化 (WoW)** | -0.6 億元 (-3.42%) | 📉 |
| **月變化 (MoM)** | -3.0 億元 (-14.75%) | 📉 |
...
![Stock 2354 Margin Balance Analysis](margin_daily-2354.svg){: style="max-width: 100%; height: auto;"}
</div>
