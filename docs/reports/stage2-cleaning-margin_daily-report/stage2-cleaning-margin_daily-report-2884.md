...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:06:42 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.7 億元 (5,320 張) | - |
| **最新收盤價** | 32.30 元 | - |
| **市值** | 5,224 億元 | - |
| **融資餘額/市值** | 0.03% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+0.62%) | 📈 |
| **週變化 (WoW)** | -0.4 億元 (-18.83%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.8 億元 (-28.73%) | 📉 |
| **月變化 (MoM)** | +0.4 億元 (+25.40%) | 📈 |
...
![Stock 2884 Margin Balance Analysis](margin_daily-2884.svg){: style="max-width: 100%; height: auto;"}
</div>
