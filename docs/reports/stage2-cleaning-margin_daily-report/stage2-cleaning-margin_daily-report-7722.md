...
| **市值** | 354 億元 | - |
| **融資餘額/市值** | 1.16% | 🔴 過熱 |
| **日變化 (DoD)** | +0.8 億元 (+24.41%) | 📈 |
| **週變化 (WoW)** | +0.8 億元 (+22.87%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.7 億元 (+19.26%) | 📈 |
| **月變化 (MoM)** | +0.8 億元 (+24.58%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7722.json" data-title="融資餘額"></div>
</div>
