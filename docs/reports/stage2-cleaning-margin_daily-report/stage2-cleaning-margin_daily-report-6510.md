...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-03-16
    **🕒 更新時間**: 2026-03-18 01:44:28 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 12.6 億元 (337 張) | - |
| **最新收盤價** | 3735.00 元 | - |
| **市值** | 1,238 億元 | - |
| **融資餘額/市值** | 1.02% | 🔴 過熱 |
| **日變化 (DoD)** | +1.4 億元 (+12.59%) | 📈 |
| **週變化 (WoW)** | +1.5 億元 (+13.17%) | 📈 |
| **兩週變化 (2Wo2W)** | -2.4 億元 (-17.65%) | 📉 |
| **月變化 (MoM)** | +0.8 億元 (+7.91%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6510.json" data-title="融資餘額"></div>
</div>
