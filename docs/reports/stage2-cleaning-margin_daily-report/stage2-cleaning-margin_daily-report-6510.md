...
| **市值** | 792 億元 | - |
| **融資餘額/市值** | 0.77% | 🟠 偏高 |
| **日變化 (DoD)** | -0.9 億元 (-13.18%) | 📉 |
| **週變化 (WoW)** | -1.4 億元 (-19.14%) | 📉 |
| **兩週變化 (2Wo2W)** | +1.2 億元 (+18.56%) | 📈 |
| **月變化 (MoM)** | -1.1 億元 (-12.40%) | 📉 |
...
![Stock 6510 Margin Balance Analysis](margin_daily-6510.svg){: style="max-width: 100%; height: auto;"}
</div>
