...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:06:40 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.3 億元 (4,354 張) | - |
| **最新收盤價** | 74.70 元 | - |
| **市值** | 1.10 兆元 | - |
| **融資餘額/市值** | 0.03% | 🟢 低風險 |
| **日變化 (DoD)** | +0.4 億元 (+13.91%) | 📈 |
| **週變化 (WoW)** | +0.2 億元 (+7.82%) | 📈 |
...
![Stock 2882 Margin Balance Analysis](margin_daily-2882.svg){: style="max-width: 100%; height: auto;"}
</div>
