...
| **市值** | 46 億元 | - |
| **融資餘額/市值** | 2.83% | 🔴 過熱 |
| **日變化 (DoD)** | +0.3 億元 (+34.27%) | 📈 |
| **週變化 (WoW)** | +0.6 億元 (+98.05%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.8 億元 (+187.83%) | 📈 |
| **月變化 (MoM)** | +1.0 億元 (+333.49%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6720.json" data-title="融資餘額"></div>
</div>
