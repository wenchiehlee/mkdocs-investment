...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 20:31:22 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 80.6 億元 (7,607 張) | - |
| **最新收盤價** | 1060.00 元 | - |
| **市值** | 2.71 兆元 | - |
| **融資餘額/市值** | 0.30% | 🟢 低風險 |
| **日變化 (DoD)** | +5.5 億元 (+7.34%) | 📈 |
...
![Stock 2308 Margin Balance Analysis](margin_daily-2308.svg){: style="max-width: 100%; height: auto;"}
</div>
