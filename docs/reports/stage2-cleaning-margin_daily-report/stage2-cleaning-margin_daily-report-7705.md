...
| **融資餘額/市值** | 0.12% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-6.47%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-20.52%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-16.84%) | 📉 |
| **月變化 (MoM)** | -0.0 億元 (-15.10%) | 📉 |
...
![Stock 7705 Margin Balance Analysis](margin_daily-7705.svg){: style="max-width: 100%; height: auto;"}
</div>
