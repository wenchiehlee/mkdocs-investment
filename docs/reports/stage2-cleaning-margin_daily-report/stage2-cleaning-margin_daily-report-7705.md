...
| **融資餘額/市值** | 0.12% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-0.63%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-16.96%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-30.27%) | 📉 |
| **月變化 (MoM)** | -0.0 億元 (-30.27%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-7705.json" data-title="融資餘額"></div>
</div>
