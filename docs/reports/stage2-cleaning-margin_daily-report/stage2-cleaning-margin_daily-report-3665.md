...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-04-10
    **🕒 更新時間**: 2026-04-11 12:42:36 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 61.0 億元 (2,775 張) | - |
| **最新收盤價** | 2200.00 元 | - |
| **市值** | 4,267 億元 | - |
| **融資餘額/市值** | 1.43% | 🔴 過熱 |
| **日變化 (DoD)** | +5.2 億元 (+9.36%) | 📈 |
| **週變化 (WoW)** | +12.3 億元 (+25.20%) | 📈 |
| **兩週變化 (2Wo2W)** | +5.7 億元 (+10.29%) | 📈 |
| **月變化 (MoM)** | +15.6 億元 (+34.35%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-3665.json" data-title="融資餘額"></div>
</div>
