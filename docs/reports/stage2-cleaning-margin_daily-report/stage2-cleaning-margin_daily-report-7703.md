...
| **融資餘額/市值** | 1.61% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+0.03%) | 📈 |
| **週變化 (WoW)** | +0.3 億元 (+24.08%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.5 億元 (+51.69%) | 📈 |
| **月變化 (MoM)** | +0.4 億元 (+47.75%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7703.json" data-title="融資餘額"></div>
</div>
