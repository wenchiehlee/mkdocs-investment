...
| **融資餘額/市值** | 1.65% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-1.30%) | 📉 |
| **週變化 (WoW)** | +0.4 億元 (+35.92%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.2 億元 (+22.66%) | 📈 |
| **月變化 (MoM)** | +0.2 億元 (+28.29%) | 📈 |
...
![Stock 7703 Margin Balance Analysis](margin_daily-7703.svg){: style="max-width: 100%; height: auto;"}
</div>
