...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-21
    **🕒 更新時間**: 2026-01-22 18:24:16 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 20.7 億元 (4,131 張) | - |
| **最新收盤價** | 502.00 元 | - |
| **市值** | 2,645 億元 | - |
| **融資餘額/市值** | 0.78% | 🟠 偏高 |
| **日變化 (DoD)** | -0.9 億元 (-4.36%) | 📉 |
| **週變化 (WoW)** | -2.7 億元 (-11.67%) | 📉 |
| **兩週變化 (2Wo2W)** | +7.9 億元 (+61.68%) | 📈 |
| **月變化 (MoM)** | +7.9 億元 (+61.73%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2379.json" data-title="融資餘額"></div>
</div>
