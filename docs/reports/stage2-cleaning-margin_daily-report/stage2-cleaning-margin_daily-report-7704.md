...
| **融資餘額/市值** | 0.33% | 🟡 正常 |
| **日變化 (DoD)** | +0.0 億元 (+5.23%) | 📈 |
| **週變化 (WoW)** | +0.0 億元 (+29.96%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.0 億元 (+102.46%) | 📈 |
| **月變化 (MoM)** | +0.0 億元 (+37.06%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7704.json" data-title="融資餘額"></div>
</div>
