...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-23
    **🕒 更新時間**: 2026-01-24 21:13:55 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.0 億元 (1,468 張) | - |
| **最新收盤價** | 67.50 元 | - |
| **市值** | 1,126 億元 | - |
| **融資餘額/市值** | 0.09% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-4.22%) | 📉 |
| **週變化 (WoW)** | -0.1 億元 (-12.29%) | 📉 |
| **兩週變化 (2Wo2W)** | -0.4 億元 (-30.74%) | 📉 |
| **月變化 (MoM)** | -0.2 億元 (-16.20%) | 📉 |
...
<div class="margin-chart" data-url="../margin_daily-2347.json" data-title="融資餘額"></div>
</div>
