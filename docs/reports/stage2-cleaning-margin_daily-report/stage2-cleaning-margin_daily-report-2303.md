...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 14:05:14 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 33.4 億元 (61,864 張) | - |
| **最新收盤價** | 54.00 元 | - |
| **市值** | 6,798 億元 | - |
| **融資餘額/市值** | 0.49% | 🟡 正常 |
| **日變化 (DoD)** | -2.0 億元 (-5.58%) | 📉 |
| **週變化 (WoW)** | +5.7 億元 (+20.37%) | 📈 |
| **兩週變化 (2Wo2W)** | +23.9 億元 (+203.98%) | 📈 |
| **月變化 (MoM)** | +23.4 億元 (+190.61%) | 📈 |
...
![Stock 2303 Margin Balance Analysis](margin_daily-2303.svg){: style="max-width: 100%; height: auto;"}
</div>
