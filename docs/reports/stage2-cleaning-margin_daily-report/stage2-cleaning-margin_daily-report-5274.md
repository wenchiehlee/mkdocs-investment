...
| **市值** | 2,898 億元 | - |
| **融資餘額/市值** | 0.23% | 🟢 低風險 |
| **日變化 (DoD)** | -1.9 億元 (-21.88%) | 📉 |
| **週變化 (WoW)** | -3.3 億元 (-32.94%) | 📉 |
| **月變化 (MoM)** | -1.7 億元 (-20.40%) | 📉 |
...
![Stock 5274 Margin Balance Analysis](margin_daily-5274.svg){: style="max-width: 100%; height: auto;"}
</div>
