...
!!! info "基本資訊"
    **🏗️ 名稱**: 光焱科技
    **🪪 代號**: 7728
    **📅 分析期間**: 2025-07-31 ~ 2026-01-22 (共 221 個交易日)
    **🕒 最新資料**: 2026-01-22
    **🕒 更新時間**: 2026-01-24 03:16:20 CST
...
| **市值** | 96 億元 | - |
| **融資餘額/市值** | 4.32% | 🔴 過熱 |
| **日變化 (DoD)** | -0.7 億元 (-14.14%) | 📉 |
| **週變化 (WoW)** | +0.5 億元 (+13.25%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.6 億元 (+15.53%) | 📈 |
| **月變化 (MoM)** | +2.3 億元 (+113.48%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-7728.json" data-title="融資餘額"></div>
</div>
