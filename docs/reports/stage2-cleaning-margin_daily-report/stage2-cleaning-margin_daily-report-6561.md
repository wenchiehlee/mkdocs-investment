...
| **市值** | 292 億元 | - |
| **融資餘額/市值** | 0.67% | 🟠 偏高 |
| **日變化 (DoD)** | +0.5 億元 (+31.97%) | 📈 |
| **週變化 (WoW)** | +0.9 億元 (+83.14%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.9 億元 (+78.74%) | 📈 |
| **月變化 (MoM)** | +0.7 億元 (+50.01%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-6561.json" data-title="融資餘額"></div>
</div>
