...
| **日變化 (DoD)** | -0.0 億元 (-3.16%) | 📉 |
| **週變化 (WoW)** | +0.0 億元 (+8.61%) | 📈 |
| **兩週變化 (2Wo2W)** | -0.0 億元 (-8.86%) | 📉 |
| **月變化 (MoM)** | -0.1 億元 (-16.87%) | 📉 |
...
![Stock 7712 Margin Balance Analysis](margin_daily-7712.svg){: style="max-width: 100%; height: auto;"}
</div>
