...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-08-14
    **🕒 更新時間**: 2026-08-15 15:27:02 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 6.5 億元 (28,563 張) | - |
| **最新收盤價** | 22.60 元 | - |
| **市值** | 134 億元 | - |
| **融資餘額/市值** | 4.81% | 🔴 過熱 |
| **日變化 (DoD)** | -0.1 億元 (-1.88%) | 📉 |
| **週變化 (WoW)** | +0.1 億元 (+1.81%) | 📈 |
| **兩週變化 (2Wo2W)** | +0.1 億元 (+1.59%) | 📈 |
| **月變化 (MoM)** | +1.8 億元 (+37.90%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2332.json" data-title="融資餘額"></div>
</div>
