...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-14
    **🕒 更新時間**: 2026-01-15 12:02:49 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 3.4 億元 (19,862 張) | - |
| **最新收盤價** | 17.05 元 | - |
| **市值** | 103 億元 | - |
| **融資餘額/市值** | 3.30% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+1.09%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+3.06%) | 📈 |
| **月變化 (MoM)** | +0.4 億元 (+13.05%) | 📈 |
...
![Stock 2332 Margin Balance Analysis](margin_daily-2332.svg){: style="max-width: 100%; height: auto;"}
</div>
