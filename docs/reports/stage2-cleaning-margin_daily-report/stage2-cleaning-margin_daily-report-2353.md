...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-14 22:37:21 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 8.1 億元 (30,712 張) | - |
| **最新收盤價** | 26.35 元 | - |
| **市值** | 840 億元 | - |
| **融資餘額/市值** | 0.96% | 🟠 偏高 |
| **日變化 (DoD)** | +0.3 億元 (+3.38%) | 📈 |
| **週變化 (WoW)** | +0.3 億元 (+4.41%) | 📈 |
| **月變化 (MoM)** | +1.2 億元 (+17.33%) | 📈 |
...
![Stock 2353 Margin Balance Analysis](margin_daily-2353.svg){: style="max-width: 100%; height: auto;"}
</div>
