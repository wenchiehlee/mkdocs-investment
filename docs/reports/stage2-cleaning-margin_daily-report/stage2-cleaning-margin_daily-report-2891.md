...
!!! info "基本資訊"
    **🏗️ 名稱**: 中信金
    **🪪 代號**: 2891
    **📅 分析期間**: 2025-11-14 ~ 2026-01-12 (共 40 個交易日)
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:59:32 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.7 億元 (3,448 張) | - |
| **最新收盤價** | 50.00 元 | - |
| **市值** | 9,766 億元 | - |
| **融資餘額/市值** | 0.02% | 🟢 低風險 |
| **日變化 (DoD)** | +0.0 億元 (+1.19%) | 📈 |
| **週變化 (WoW)** | -0.0 億元 (-0.41%) | 📉 |
| **月變化 (MoM)** | -0.4 億元 (-18.99%) | 📉 |
...
![Stock 2891 Margin Balance Analysis](margin_daily-2891.svg){: style="max-width: 100%; height: auto;"}
</div>
