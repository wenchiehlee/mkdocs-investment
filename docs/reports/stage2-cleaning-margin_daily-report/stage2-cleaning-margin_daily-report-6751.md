...
| **融資餘額/市值** | 0.13% | 🟢 低風險 |
| **日變化 (DoD)** | -0.0 億元 (-9.21%) | 📉 |
| **週變化 (WoW)** | -0.0 億元 (-21.88%) | 📉 |
| **月變化 (MoM)** | +0.0 億元 (+12.56%) | 📈 |
...
![Stock 6751 Margin Balance Analysis](margin_daily-6751.svg){: style="max-width: 100%; height: auto;"}
</div>
