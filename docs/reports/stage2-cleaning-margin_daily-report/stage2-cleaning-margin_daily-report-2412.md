...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-08-14
    **🕒 更新時間**: 2026-08-25 11:48:10 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.7 億元 (1,979 張) | - |
| **最新收盤價** | 135.00 元 | - |
| **市值** | 1.06 兆元 | - |
| **融資餘額/市值** | 0.03% | 🟢 低風險 |
| **日變化 (DoD)** | +0.1 億元 (+2.58%) | 📈 |
| **週變化 (WoW)** | -0.7 億元 (-20.63%) | 📉 |
| **兩週變化 (2Wo2W)** | -3.6 億元 (-57.30%) | 📉 |
| **月變化 (MoM)** | +0.3 億元 (+14.89%) | 📈 |
...
<div class="margin-chart" data-url="../margin_daily-2412.json" data-title="融資餘額"></div>
</div>
