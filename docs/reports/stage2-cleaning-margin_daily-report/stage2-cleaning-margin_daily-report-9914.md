...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-12
    **🕒 更新時間**: 2026-01-13 11:57:41 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 2.8 億元 (3,524 張) | - |
| **最新收盤價** | 80.40 元 | - |
| **市值** | 242 億元 | - |
| **融資餘額/市值** | 1.17% | 🔴 過熱 |
| **日變化 (DoD)** | +0.0 億元 (+0.28%) | 📈 |
| **週變化 (WoW)** | +0.1 億元 (+3.12%) | 📈 |
| **月變化 (MoM)** | -0.4 億元 (-13.01%) | 📉 |
...
![Stock 9914 Margin Balance Analysis](margin_daily-9914.svg){: style="max-width: 100%; height: auto;"}
</div>
