...
!!! info "基本資訊"
    ...
    **🕒 最新資料**: 2026-01-13
    **🕒 更新時間**: 2026-01-15 02:10:20 CST

## 💰 融資餘額現況

| 📊 指標 | 🔢 數值 | 🚦 狀態 |
|:------------:|:----------:|:-------------------:|
| **最新融資餘額** | 1.6 億元 (1,828 張) | - |
| **最新收盤價** | 87.50 元 | - |
| **市值** | 71 億元 | - |
| **融資餘額/市值** | 2.26% | 🔴 過熱 |
| **日變化 (DoD)** | -0.0 億元 (-1.01%) | 📉 |
| **週變化 (WoW)** | +0.0 億元 (+1.41%) | 📈 |
| **月變化 (MoM)** | -0.3 億元 (-14.10%) | 📉 |
...
![Stock 5203 Margin Balance Analysis](margin_daily-5203.svg){: style="max-width: 100%; height: auto;"}
</div>
