...
|:--------:|:------:|:------:|:------:|:------:|:--------:|:----------:|:-----------:|
| **現金殖利率(%)** | 4.17 | 4.02 | 4.15 | 3.12 | 2.93 | 3.61 | +0.6% 🟢 |
| **總殖利率(%)** | 4.17 | 4.17 | 4.47 | 4.02 | 4.72 | - | - |
| **配息率(%)** | 86.4 | 82.8 | 87.9 | 79.9 | 83.0 | - | - |
...
!!! abstract "殖利率評估"
    :chart_with_upwards_trend: 高於平均殖利率(4.17% vs 產業 3.61%)。配息率偏高(86.4%)需要持續關注。
...
- **最新配息率**: 86.4% → 🟡 **偏高** (需要密切關注: 70-100%)
- **EPS涵蓋倍數**: 1.16x → 📊 **適當** (最新股利 ÷ 最新EPS = 1.40 ÷ 1.62)
- **股利穩定性評分**: 7.0/10 → 📊 **穩定**
...
!!! tip "預測結果"
    ...
    **與2025年比較**: 📉 預期下降 5.8% (較2025年減少 0.07元)

### 情境分析表

| 情境 | 預測股利 | 計算可靠度 | 發生機率 | 期望值貢獻 | 條件假設 |
|:----:|:--------:|:----------:|:--------:|:----------:|:---------|
| 🟢 樂觀 | **1.13元** | 5.3/10 🟠 | **45%** | 0.51元 | Q4回升至0.33元 |
| 📊 基準 | **1.13元** | 8.3/10 🟢 | **25%** | 0.28元 | Q4維持0.33元 |
| 🔴 保守 | **1.13元** | 7.3/10 🟢 | **30%** | 0.34元 | Q4轉弱至0.33元 |
