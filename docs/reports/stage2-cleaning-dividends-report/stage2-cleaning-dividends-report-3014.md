...
!!! abstract "殖利率評估"
    :chart_with_upwards_trend: 高於平均殖利率(6.72% vs 產業 3.27%)。配息率偏高(89.1%)需要持續關注。
...
| 🟡 **配息率可持續性** | 1.0 | 2.0 | 50% | 平均83.2% (偏高但可持續) |
